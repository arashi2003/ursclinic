...
if (isset($_GET['campus'])) {
    ...
    if ($campus !== '') {
        $whereClause .= " WHERE campus LIKE '%$campus%'";
    }

    // Construct and execute SQL query for counting total rows
    $sql_count = "SELECT COUNT(*) AS total_rows FROM campus $whereClause ORDER BY campus";
} else {
    // If filters are not set, count all rows
    $sql_count = "SELECT COUNT(*) AS total_rows FROM campus ORDER BY campus";
}
