            ...
            <div class="right-nav">
                <div class="notification-button">
                    <button type="button" class="btn btn-sm position-relative" onclick="window.location.href = 'notification'">
                        ...
                        WHERE 
                        ((au.activity LIKE 'approved a request for%' AND au.activity LIKE '%$userid') OR
                        (au.activity LIKE 'disapproved a request for% ' AND au.activity LIKE '%$userid') OR
                        (au.activity LIKE 'cancelled a request for ' AND au.activity LIKE '%$userid') OR
                        (au.activity LIKE 'approved a request for ' AND au.activity LIKE '%$userid') OR
                        (au.activity LIKE 'completed a request for ' AND au.activity LIKE '%$userid') OR
                        (au.activity LIKE 'dismissed a request for ' AND au.activity LIKE '%$userid') OR
                        (au.activity LIKE 'added a walk-in schedule%' AND au.activity LIKE '%$campus') OR
                        (au.activity LIKE 'cancelled a walk-in schedule%' AND au.activity LIKE '%$campus'))
