...
if (isset($_GET['supply'])) {
    ...
    if ($supply !== '') {
        $whereClause .= " WHERE supply LIKE '%$supply%'";
    }

    // Construct and execute SQL query for counting total rows
    $sql_count = "SELECT COUNT(*) AS total_rows FROM supply $whereClause";
} else {
    // If filters are not set, count all rows
    $sql_count = "SELECT COUNT(*) AS total_rows FROM supply";
}
                ...
                <div class="inv-tabs">
                    <div class="tabs">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a class="nav-link" href="med_entry">Medicine</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addsupentry">Add Supply</button>
