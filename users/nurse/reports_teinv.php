...
$records = $conn->query("SELECT * FROM report_teinv WHERE campus = '$campus' AND date='$now' ORDER BY tools_equip ");
    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                <span class="dashboard"><H1>TOOLS AND EQUIPMENT INVENTORY REPORT</H1></span>
            </div>
            <div class="right-nav">
        ...
        <div class="home-content">
            <div class="overview-boxes">
                <div class="schedule-button">
                    <button type="button" class="btn btn-primary btn-lg" onclick="window.open('reports/reports_teinv.php');">Export to PDF</button>
                </div>
                <div class="content">
                    <div class="row">
                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 mb-3">
                                            <select name="reports" class="form-select">
                                                ...
                                                <option value="teinv" selected>Tools and Equipment Inventory Report</option>
