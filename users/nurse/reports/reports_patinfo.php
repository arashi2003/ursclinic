<?php
    ...
    $query = mysqli_query($conn, "SELECT firstname,  middlename, lastname, a.email, a.contactno, a.campus, designation, age, sex, birthday, pi.department, college, program, yearlevel, section, emcon_number, emcon_name FROM account a INNER JOIN patient_info pi ON pi.patientid=a.accountid $ca $depa $co $pr $y $des ORDER BY lastname");
    $count = 1;
    while($data=mysqli_fetch_array($query))
    {
