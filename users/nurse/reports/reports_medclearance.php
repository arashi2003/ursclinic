<?php
    ...
    firstname, middlename, lastname, account.campus, designation, sex, birthday, department, college, program, yearlevel, section FROM account INNER JOIN patient_info pi ON pi.patientid=account.accountid WHERE accountid = '$account_no'");
