...
if (isset($_GET['designation'])) {
    ...
    if ($designation !== '') {
        $whereClause .= " WHERE designation LIKE '%$designation%'";
    }

    // Construct and execute SQL query for counting total rows
    $sql_count = "SELECT COUNT(*) AS total_rows FROM designation $whereClause ORDER BY designation";
} else {
    // If filters are not set, count all rows
    $sql_count = "SELECT COUNT(*) AS total_rows FROM designation ORDER BY designation";
}
                ...
                <div class="inv-tabs">
                    <div class="tabs">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="#">Designation</a>
                            </li>
                            <li class="nav-item">
