        ...
        <nav>
            <div class="sidebar-button">
                ...
                <span class="dashboard">
                    <h1>MEDICAL DOCUMENTS ACCOMPLISHMENT REPORT</h1>
                </span>
            </div>
            <div class="right-nav">
        ...
        <div class="home-content">
            <div class="overview-boxes">
                <div class="schedule-button">
                    <form action="reports/reports_meddoc" method="post" id="exportPdfForm" target="_blank">
                        <!-- Hidden input fields to store filter values -->
                        <input type="hidden" value="<?= isset($_GET['patient']) == true ? $_GET['patient'] : '' ?>" name="student" id="student">
                        ...
                        <input type="hidden" value="<?= isset($_GET['docu']) == true ? $_GET['docu'] : '' ?>" name="docu" id="docu">
                                    ...
                                    <div class="col-md-2 mb-2">
                                        <form action="reports_filter.php" method="POST" id="reportForm">
                                            <select name="reports" class="form-select" id="reportSelect">
                                                ...
                                                <option value="meddoc" selected>Medical Documents Accomplishment Report</option>
                                        ...
                                        <form action="" method="GET" id="filterForm">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <a href="reports_meddoc" class="btn btn-danger">Reset</a>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
