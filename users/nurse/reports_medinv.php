...
$records = $conn->query("SELECT * FROM report_medsupinv WHERE type='medicine' AND campus = '$campus' AND date='$now'  ORDER BY medicine ");
    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                <span class="dashboard">MEDICINE CONSUMPTION REPORT</span>
            </div>
            <div class="right-nav">
        ...
        <div class="home-content">
            <div class="overview-boxes">
                <div class="schedule-button">
                    <button type="button" class="btn btn-primary btn-lg" onclick="window.open('reports/reports_medinv.php');">Export to PDF</button>
                </div>
                <div class="content">
                    <div class="row">
                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 mb-3">
                                            <select name="reports" class="form-select">
                                                ...
                                                <option value="medinv" selected>Medicine Consumption Report</option>
                                ...
                                <form action="" method="GET">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <a href="reports_medinv" class="btn btn-danger">Reset</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
