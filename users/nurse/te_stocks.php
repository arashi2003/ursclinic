        ...
        <div class="home-content">
            <div class="overview-boxes">
                <div class="inv-tabs">
                    ...
                    <div>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addtestocks">Add Tools/Equipment</button>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#calimain<?php echo $data['id'] ?>">Maintenance/Calibration</button>
                                                        </td>
                                                    </tr>
                                                <?php
