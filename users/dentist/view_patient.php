                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($data['purpose'] == 'Dental Checkup') { ?>
                                                                <button type="button" class="btn btn-primary btn-sm" onclick="window.open('reports/reports_dentalform.php?patientid=<?= $id ?>')" target="_blank">Expand</button>
                                                            <?php } else { ?>
